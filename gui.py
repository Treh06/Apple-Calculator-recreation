...
"min-height: 80px;")
        ...
        self.prev_num_display.setFont(font)
        self.prev_num_display.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.prev_num_display.setStyleSheet("background-color: black;\n"
"color: white;")
        self.prev_num_display.setText("")
        self.prev_num_display.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
